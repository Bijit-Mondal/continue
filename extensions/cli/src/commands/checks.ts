...
/**
 * Main entry point for `tezz checks` command.
 *
 * Usage:
 *   tezz checks [pr-url]              - List checks with diffs
 *   tezz checks accept [pr-url]       - Accept pending suggestions
 *   tezz checks reject [pr-url]       - Reject pending suggestions
 */
